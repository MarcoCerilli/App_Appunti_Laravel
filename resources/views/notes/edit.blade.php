        ...
        <div class="w-full max-w-3xl">
            ...
            <div class="bg-white shadow-xl rounded-xl overflow-hidden">
                ...
                <div class="p-6 text-white" style="background-color: #6c5ce7;">
                    {{-- TITOLO: Sostituisce .mb-0 --}}
                    <h3 class="text-xl font-semibold">{{ Str::limit($note->title, 40) }}</h3>
                </div>
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('notes.update', $note) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('title') border-red-500 @enderror" value="{{ old('title', $note->title) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            {{-- TEXTAREA --}}
                            <textarea name="content" id="content" rows="8" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('content') border-red-500 @enderror" required>{{ old('content', $note->content) }}</textarea>
                        ...
                        <div class="flex items-center mb-4 pt-3 border-t border-gray-200">
                            ...
                            <input type="checkbox" name="is_pinned" id="is_pinned" value="1" class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" {{ old('is_pinned', $note->is_pinned) ? 'checked' : '' }}>
